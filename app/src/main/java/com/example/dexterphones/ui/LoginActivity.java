...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    @BindView(R.id.login_signup_text_view) TextView mRegisterTextView;
    @BindView(R.id.login_login_btn) Button mPasswordLoginButton;
    @BindView(R.id.login_email_edit_text) TextInputEditText mEmailEditText;
